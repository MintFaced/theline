...
export const metadata: Metadata = {
  title: 'Join The Line',
  description: 'Join The Line as an artist or support as a Guardian. Get your Line number, a dedicated profile, and access to the artist community.',
}
            ...
            <div className="flex-1">
              ...
              <div className="space-y-px bg-line-border mb-8">
                ...
                <div className="bg-line-surface px-6 py-4 flex items-center justify-between">
                  ...
                  <span className="font-display font-light text-2xl text-line-accent" style={{ letterSpacing: '-0.02em' }}>$10 <span className="font-mono text-sm text-line-muted">/ mo</span></span>
                </div>
              </div>
          ...
          <div className="bg-line-bg p-8 md:p-10">
            <div className="max-w-content mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
              <div>
                ...
                <p className="font-sans text-sm text-line-muted leading-relaxed max-w-lg">
                  A private, tokenized community for Line Artists and Guardians. No bots. No AI. No one who hasn&apos;t earned their place. Just the artists and the people who support them.
                </p>
              </div>
