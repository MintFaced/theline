...
const MANIFOLD_URL = 'https://app.manifold.xyz/c/guardians-of-the-line'
        ...
        <div className="max-w-content mx-auto px-6 py-16 md:py-24">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-wrap gap-3">
              <a href={MANIFOLD_URL} target="_blank" rel="noopener noreferrer" className="btn-primary">
                Become a Guardian →
              </a>
              <a href={OPENSEA_URL} target="_blank" rel="noopener noreferrer" className="btn-outline">
                View on OpenSea
              </a>
            </div>
          </div>
      ...
      <div className="max-w-content mx-auto px-6">
        ...
        <div className="py-16 md:py-24 border-b border-line-border grid md:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <h2 className="font-display font-light text-4xl text-line-text" style={{ letterSpacing: '-0.02em' }}>
        ...
        <div className="py-16 md:py-24 border-b border-line-border grid md:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="font-sans text-sm text-line-muted leading-relaxed">
              The Line Gallery sits in Napier, New Zealand. Guardian support funds the exhibitions, the artist retreats, and the continued building of the platform — independent of marketplaces, independent of VC, independent of any single platform&apos;s survival.
            </p>
          </div>
          <div className="space-y-px bg-line-border">
            {[
              { label: 'Physical exhibitions', desc: 'Line artist work shown in the gallery space in Napier, New Zealand — a real exhibition record, not an honorary listing.' },
        ...
        <div className="py-16 md:py-24 border-b border-line-border grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="space-y-4 font-sans text-sm text-line-muted leading-relaxed mb-8">
              <p>
                Line Guardians is a limited set of supporter tokens minted on Manifold. Each token is a permanent on-chain record of your support — and your access key to the Guardian tier.
              </p>
              <p>
                The token is tradeable. The Guardian benefits travel with it. Whoever holds the token is a Guardian.
              </p>
              <p>
                Guardian token holders also receive access to LARP Chat — the private community for Line Artists. Collect alongside the artists. Be part of the conversation.
              </p>
            </div>
            <div className="flex flex-wrap gap-3">
              <a href={MANIFOLD_URL} target="_blank" rel="noopener noreferrer" className="btn-primary">
          ...
          <div className="border border-line-border bg-line-surface aspect-square flex flex-col items-center justify-center gap-4">
            <p className="font-mono text-[10px] text-line-muted tracking-widest">LINE GUARDIANS</p>
            <p className="font-display font-light text-8xl text-line-accent" style={{ letterSpacing: '-0.03em' }}>G</p>
            <p className="font-mono text-[10px] text-line-muted tracking-widest">LIMITED EDITION</p>
          </div>
        </div>
        ...
        <div className="py-16 md:py-24">
          <div className="max-w-xl">
            ...
            <p className="font-sans text-sm text-line-muted leading-relaxed mb-8">
              Art is at the centre of the crypto revolution. There is no art without artists. Become a Guardian of The Line and change the future of Line artists.
            </p>
            <div className="flex flex-wrap gap-3">
              <a href={MANIFOLD_URL} target="_blank" rel="noopener noreferrer" className="btn-primary">
                Become a Guardian →
