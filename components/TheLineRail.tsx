...
const NODE_WIDTH = 72       // px per slot (includes gap)
const NODE_SIZE_REST = 48   // resting thumbnail size
const RAIL_HEIGHT = 520     // px, ~70vh equivalent for the list

// Build a full 0–1000 slot map
function buildSlots(artists: Artist[]) {
